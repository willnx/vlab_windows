...
from vlab_windows_api.lib.views import healthcheck
...
class TestHealthView(unittest.TestCase):
    ...
    def test_health_check(self):
        """A simple test to verify the /api/1/inf/windows/healthcheck end point works"""
        resp = self.app.get('/api/1/inf/windows/healthcheck')
