...
class TestWindowsViewSchema(unittest.TestCase):
    """A set of test cases for the schemas of /api/1/inf/windows"""

    def test_post_schema(self):
        """The schema defined for POST on is valid"""
        try:
            Draft4Validator.check_schema(windows.WindowsView.POST_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
    ...
    def test_get_schema(self):
        ...
        try:
            Draft4Validator.check_schema(windows.WindowsView.GET_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
    ...
    def test_delete_schema(self):
        ...
        try:
            Draft4Validator.check_schema(windows.WindowsView.DELETE_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
    ...
    def test_iamges_schema(self):
        ...
        try:
            Draft4Validator.check_schema(windows.WindowsView.IMAGES_SCHEMA)
            schema_valid = True
        except RuntimeError:
            schema_valid = False
