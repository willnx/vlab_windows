...
DEFINED = OrderedDict([
            ('VLAB_WINDOWS_LOG_LEVEL', environ.get('VLAB_WINDOWS_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'windows-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_WINDOWS_IMAGES_DIR', environ.get('VLAB_WINDOWS_IMAGES_DIR', '/images')),
          ])
